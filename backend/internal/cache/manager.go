// Package cache provides a comprehensive cache manager that combines all caching functionality
package cache
...
func (m *Manager) AllowN(ctx context.Context, key string, n int64, limit int64, window time.Duration) (bool, error) {
